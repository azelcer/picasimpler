...
class ViewSignals(QObject):
    ...
    send_n1_guess_fromui = pyqtSignal(object)
    send_n2_guess_fromui = pyqtSignal(object)
    send_n3_guess_fromui = pyqtSignal(object)
    send_n4_guess_fromui = pyqtSignal(object)
